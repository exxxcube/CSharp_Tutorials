...
namespace PolymorphicInheritance
{
    ...
    public class SavingsAccount : BankAccount
    {
        ...
        {
            return String.Format("Account Balance: {0}", Balance);
        }
    }
    public class HidingWithdrawalClass
    {
        ...
        {
            ba.Withdraw(amount); // Since the Withdraw() method is override the C# language will
                                 // decide what Withdraw() method should be use.
                                 // base on the object type reference ba.
        }
        public static void HidingWithdrawalMain()
        {
            ...
            Console.WriteLine(sa.ToString()); // overriding ToString() Method
